...
>
> 🧪 **[实测工作流 →](recipes/)** —— 5 条**真跑过**的流水线（含实际输出与踩坑），全部无需 API key。
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | ~40.6k | 🟢 | CC-BY-NC-4.0 | **本领域最受欢迎的项目。** 一套 Claude Code 技能，10 阶段流水线（研究→写作→评审→修订→定稿），内置引用/论断「诚信门」，跨 Semantic Scholar + OpenAlex + Crossref 三源校验。理念：*「AI 是副驾，不是主驾」*。`/plugin install academic-research-skills` |
| [academic-research-skills-codex](https://github.com/Imbad0202/academic-research-skills-codex) | ~7.7k | 🟢 | CC-BY-NC-4.0 | 上者的 Codex 原生版，人在环中的学术研究流程 |
| [Research-Paper-Writing-Skills](https://github.com/Master-cai/Research-Paper-Writing-Skills) | ~5.7k | 🟢 | MIT | ML/CV/NLP 论文写作技能包（改编自彭思达老师笔记），兼容 Codex / Claude Code / Gemini |
| [claude-skills](https://github.com/alirezarezvani/claude-skills) | ~23.7k | 🟢 | MIT | 大型技能合集，内含 litreview / grants / deep-research 研究栈，跨 Claude Code / Codex / Gemini / Cursor |
...
| [qinyan-academic-skills](https://github.com/LeonChaoX/qinyan-academic-skills) | 752 | 🟢 | MIT | 多语言的 182 个可安装 AI 智能体技能库，覆盖多学科 |
| [agent-research-skills](https://github.com/lingzhi227/agent-research-skills) | 255 | 🟡 | none | 面向系统性文献综述的 Claude Code 技能，含引用校验脚本 |
| [medsci-skills](https://github.com/Aperivue/medsci-skills) | 230 | 🟢 | MIT | 医学科研技能：检索、报告规范/引用核查、统计、出版图表、投稿（医生-研究者出品） |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [STORM](https://github.com/stanford-oval/storm) | ~30.8k | 🟡 | MIT | 斯坦福 OVAL 出品，基于检索的「预写作 + 写作」两阶段，生成维基百科式长文并附引用；含多智能体对话式版本 Co-STORM |
| ⭐ [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | ~28.8k | 🟢 | Apache-2.0 | 自主研究智能体，对任意主题做深度调研并生成带引用报告；通用型，非学术专用 |
| [deep-research](https://github.com/dzhng/deep-research) | ~19.5k | 🟡 | MIT | 极简的迭代式深度研究智能体（搜索 + 抓取 + LLM 精炼），代码短小易改 |
| [open_deep_research](https://github.com/langchain-ai/open_deep_research) | ~12.5k | 🟢 | MIT | LangChain 官方的开源深度研究参考实现 |
...
| [SurveyX](https://github.com/IAAR-Shanghai/SurveyX) | 988 | 🟡 | none | 从一个主题自动生成学术综述论文 |
| [LitLLM](https://github.com/LitLLM/LitLLM) | 45 | 🟢 | Apache-2.0 | 专注科学文献综述的工具包，用 RAG + 提示工程快速生成 related work（TMLR 2025） |
| [opendraft](https://github.com/federicodeponte/opendraft) | 357 | 🟢 | MIT | 免费开源的 AI 论文写作，19 个智能体协作起草长文 |
...
| [AutoResearchClaw](https://github.com/aiming-lab/AutoResearchClaw) | ~14.0k | 🟢 | MIT | 自进化的自主科研：从想法到可投稿 LaTeX 论文（OpenAlex/S2/arXiv 真实文献 + 沙盒实验 + 多智能体评审） |
| [Agent-Laboratory](https://github.com/SamuelSchmidgall/AgentLaboratory) | ~5.8k | 🟡 | MIT | 端到端自主研究流程：文献综述 → 实验 → 报告写作 |
| [SciAgentsDiscovery](https://github.com/lamm-mit/SciAgentsDiscovery) | 629 | 🔴 | Apache-2.0 | 多智能体（本体学家/科学家/批评家）自动生成假设与科学发现 |
| [Zochi](https://github.com/IntologyAI/Zochi) | 312 | 🟡 | MIT | 「人工科学家」，从发现到被同行评审接收的端到端 |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [paper-qa](https://github.com/Future-House/paper-qa) | ~9.0k | 🟢 | Apache-2.0 | FutureHouse 出品，高精度科学文献 RAG，回答**必带引用**；PaperQA2 号称文献检索达到超人水平 |
| [paperai](https://github.com/neuml/paperai) | ~1.8k | 🟢 | Apache-2.0 | 面向医学与科研论文的语义检索 + 问答 |
| [openpaper](https://github.com/khoj-ai/openpaper) | 401 | 🟢 | AGPL-3.0 | 科研文库工作台：阅读/标注论文 + 带引用溯源的 AI 综述助手 |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [ASReview](https://github.com/asreview/asreview) | 963 | 🟢 | Apache-2.0 | 主动学习的系统综述筛选工具，交互式排序论文、大幅缩短筛选时间；学术界成熟方案 |
| [LatteReview](https://github.com/PouriaRouzrokh/LatteReview) | 119 | 🟢 | CC-BY-NC-ND-4.0 | 低代码 Python 包，用 AI 智能体自动化系统综述筛选（OpenAI/Gemini/Claude/Ollama） |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [zotero-mcp](https://github.com/54yyyu/zotero-mcp) | ~4.5k | 🟢 | MIT | 把 Zotero 文献库（本地 + Web API）接给 AI：语义检索、PDF 全文、引用分析。最流行的 Zotero MCP |
...
| [PubMed-MCP-Server](https://github.com/JackKuo666/PubMed-MCP-Server) | 124 | 🔴 | MIT | 检索、访问与分析 PubMed 文章（元数据 + 深度分析） |
| [alex-mcp](https://github.com/drAbreu/alex-mcp) | 52 | 🟡 | MIT | OpenAlex MCP，专注作者消歧与机构/成果查询 |
| [openalex-research-mcp](https://github.com/oksure/openalex-research-mcp) | 39 | 🟢 | MIT | OpenAlex（2.4 亿+ 成果）：引用分析、研究趋势、合作网络 |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| ⭐ [MinerU](https://github.com/opendatalab/MinerU) | ~76.6k | 🟢 | Apache-2.0 | 高精度 PDF/Office → LLM 就绪的 Markdown/JSON（VLM+OCR，100+ 语言，公式/表格） |
| [docling](https://github.com/docling-project/docling) | ~64.1k | 🟢 | MIT | IBM 出品的文档解析器，为 GenAI/RAG 准备 PDF/文档 |
| [marker](https://github.com/datalab-to/marker) | ~38.2k | 🟢 | Apache-2.0 | 快速把 PDF/文档转成干净 Markdown/JSON，对科研文档友好 |
| [PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate) | ~35.9k | 🟢 | AGPL-3.0 | 保留排版的科研 PDF 翻译（公式/图表不变形） |
...
| [pyalex](https://github.com/J535D165/pyalex) | 402 | 🟢 | MIT | 轻量的 OpenAlex API Python 接口 |
| [ArxivDigest](https://github.com/AutoLLM/ArxivDigest) | 453 | 🔴 | MIT | 个性化每日 arXiv 摘要，GPT 打相关性分 + 邮件推送 |
...
| 项目 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| [lmms-lab-writer](https://github.com/EvolvingLMMs-Lab/lmms-lab-writer) | 258 | 🟢 | MIT | 本地优先的 agentic LaTeX 写作，用于 AI 辅助学术写作 |
| [academic-writing-agents](https://github.com/andrehuang/academic-writing-agents) | 154 | 🟢 | MIT | Claude Code 插件：10+ 专家智能体协作做学术写作评审、调研、起草、润色 |
...
| 清单 | Stars | 状态 | 许可证 | 说明 |
|---|---|---|---|---|
| [Awesome-LLM-Scientific-Discovery](https://github.com/HKUST-KnowComp/Awesome-LLM-Scientific-Discovery) | 424 | 🟢 | MIT | EMNLP 2025 综述清单：LLM 用于科学发现 |
...
| [awesome-ai-auto-research](https://github.com/worldbench/awesome-ai-auto-research) | 456 | 🟢 | MIT | AI 自动科研综述 |
| [LLM4SR](https://github.com/du-nlp-lab/LLM4SR) | 131 | 🔴 | MIT | LLM 用于科学研究综述的论文与资源合集 |
| [awesome-ai-research-tools](https://github.com/0x11c11e/awesome-ai-research-tools) | 55 | 🟢 | CC0-1.0 | 文献综述、文献管理、数据分析等 AI 科研工具 |
