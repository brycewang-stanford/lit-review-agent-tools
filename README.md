...
| [medsci-skills](https://github.com/Aperivue/medsci-skills) | ~0.2k | 医学科研技能：检索、报告规范/引用核查、统计、出版图表、投稿（医生-研究者出品） |
...
| 项目 | Stars | 说明 |
|---|---|---|
| ⭐ [STORM](https://github.com/stanford-oval/storm) | ~30.3k | 斯坦福 OVAL 出品，基于检索的「预写作 + 写作」两阶段，生成维基百科式长文并附引用；含多智能体对话式版本 Co-STORM |
| ⭐ [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | ~28.6k | 自主研究智能体，对任意主题做深度调研并生成带引用报告；通用型，非学术专用 |
| [deep-research](https://github.com/dzhng/deep-research) | ~19.4k | 极简的迭代式深度研究智能体（搜索 + 抓取 + LLM 精炼），代码短小易改 |
...
| 项目 | Stars | 说明 |
|---|---|---|
| ⭐ [AI-Scientist](https://github.com/SakanaAI/AI-Scientist) | ~14.3k | Sakana AI，端到端全自动科学发现（文献→实验→写作→评审）；另有 [v2](https://github.com/SakanaAI/AI-Scientist-v2)（~6.9k，agentic 树搜索，达 workshop 级） |
| [AutoResearchClaw](https://github.com/aiming-lab/AutoResearchClaw) | ~13.9k | 自进化的自主科研：从想法到可投稿 LaTeX 论文（OpenAlex/S2/arXiv 真实文献 + 沙盒实验 + 多智能体评审） |
| [Agent-Laboratory](https://github.com/SamuelSchmidgall/AgentLaboratory) | ~5.8k | 端到端自主研究流程：文献综述 → 实验 → 报告写作 |
| [SciAgentsDiscovery](https://github.com/lamm-mit/SciAgentsDiscovery) | ~0.6k | 多智能体（本体学家/科学家/批评家）自动生成假设与科学发现 |
| [Zochi](https://github.com/IntologyAI/Zochi) | ~0.3k | 「人工科学家」，从发现到被同行评审接收的端到端 |
| [DeepInnovator](https://github.com/HKUDS/DeepInnovator) | ~0.3k | 自主生成研究想法、问题、可检验假设与实验设计 |
...
| 项目 | Stars | 说明 |
|---|---|---|
| ⭐ [paper-qa](https://github.com/Future-House/paper-qa) | ~8.9k | FutureHouse 出品，高精度科学文献 RAG，回答**必带引用**；PaperQA2 号称文献检索达到超人水平 |
| [paperai](https://github.com/neuml/paperai) | ~1.8k | 面向医学与科研论文的语义检索 + 问答 |
| [openpaper](https://github.com/khoj-ai/openpaper) | ~0.4k | 科研文库工作台：阅读/标注论文 + 带引用溯源的 AI 综述助手 |
...
| [openalex-research-mcp](https://github.com/oksure/openalex-research-mcp) | ~37 | OpenAlex（2.4 亿+ 成果）：引用分析、研究趋势、合作网络 |
...
| 项目 | Stars | 说明 |
|---|---|---|
| ⭐ [zotero-gpt](https://github.com/MuiseDestiny/zotero-gpt) | ~7.3k | 把 GPT 集成进 Zotero，直接和你的文献库对话 |
| [papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero) | ~2.6k | Zotero AI + MCP 插件，跨 30+ LLM 聊天/批量处理 PDF |
| [ai-research-assistant](https://github.com/lifan0127/ai-research-assistant) | ~1.7k | Zotero 内的「Aria」LLM 研究助手 |
| [paper-note-filler](https://github.com/chauff/paper-note-filler) | ~47 | Obsidian 插件，从 arXiv / ACL Anthology / Semantic Scholar 自动建笔记 |
...
| 项目 | Stars | 说明 |
|---|---|---|
| [scholarly](https://github.com/scholarly-python-package/scholarly) | ~1.9k | Pythonic 的 Google Scholar 作者/论文检索 |
| [semanticscholar](https://github.com/danielnsilva/semanticscholar) | ~0.5k | Semantic Scholar API 的非官方 Python 客户端 |
| [pyalex](https://github.com/J535D165/pyalex) | ~0.4k | 轻量的 OpenAlex API Python 接口 |
| [ArxivDigest](https://github.com/AutoLLM/ArxivDigest) | ~0.5k | 个性化每日 arXiv 摘要，GPT 打相关性分 + 邮件推送 |
| [citegraph](https://github.com/Citegraph/citegraph) | ~22 | 500 万+ 论文/引用网络的开源可视化（CS 文献） |
...
| 项目 | Stars | 说明 |
|---|---|---|
| [lmms-lab-writer](https://github.com/EvolvingLMMs-Lab/lmms-lab-writer) | ~0.3k | 本地优先的 agentic LaTeX 写作，用于 AI 辅助学术写作 |
| [academic-writing-agents](https://github.com/andrehuang/academic-writing-agents) | ~0.1k | Claude Code 插件：10+ 专家智能体协作做学术写作评审、调研、起草、润色 |
| [ai-peer-review](https://github.com/poldrack/ai-peer-review) | ~0.2k | 多 LLM 元评审：独立评审 + 综合成 meta-review |
| [open_reviewer](https://github.com/maxidl/openreviewer) | ~14 | 为 ML/AI 会议论文生成高质量同行评审，用于投稿前反馈 |
| [academic-research-plugin](https://github.com/JeanDiable/academic-research-plugin) | ~17 | Claude Code 插件：文献综述、论文评审、引用管理，检索 arXiv/S2/DBLP 并识别研究空白 |
...
| 清单 | Stars | 说明 |
|---|---|---|
| [Awesome-LLM-Scientific-Discovery](https://github.com/HKUST-KnowComp/Awesome-LLM-Scientific-Discovery) | ~0.4k | EMNLP 2025 综述清单：LLM 用于科学发现 |
| [Awesome-Auto-Research-Tools](https://github.com/handsome-rich/Awesome-Auto-Research-Tools) | ~1.1k | 自动化文献检索、论文阅读、实验管理与代码生成 |
| [awesome-ai-auto-research](https://github.com/worldbench/awesome-ai-auto-research) | ~0.4k | AI 自动科研综述 |
